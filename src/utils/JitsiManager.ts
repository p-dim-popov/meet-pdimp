...
class JitsiManagerClass {
    ...
    // DOMAIN = 'pdimp.herokuapp.com/jitsi'
    DOMAIN = 'beta.meet.jit.si'
    // DOMAIN = 'alpha.jitsi.net'
    // DOMAIN = 'jitsi.riot.im'
    BASE_URL = `https://${this.DOMAIN}`
    EXTERNAL_API_URL = `${this.BASE_URL}/external_api.js`;

    async loadExternalApi() {
        await jsonPLoader.load(this.EXTERNAL_API_URL);
        // @ts-ignore
    ...
    get config() {
        return {
            ...
            // Websocket URL
            websocket: `//beta.meet.jit.si/xmpp-websocket`,
             ...
             */
            dynamicBrandingUrl: 'https://pdimp.herokuapp.com/jitsi-branding',
             ...
             */
            brandingRoomAlias: window.location.toString(),
    ...
    get interfaceConfig() {
        return {
            ...
            DEFAULT_REMOTE_DISPLAY_NAME: 'Fellow Partner',
